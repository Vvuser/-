<template>
  <div>
    <p class="default" v-if="showFlag.length==0 || showFlag==''">
      页面暂无展示内容，请进行
      <span @click="getTree()">[配置]</span>
    </p>
    <p class="reset" v-else>
      <span @click="getTree()">[重新配置]</span>
    </p>
    ...
    <el-dialog title="自定义" :visible.sync="pageBox" width="30%" :lock-scroll="true">
      <div class="box">
        <el-tree
          :data="data2"
          show-checkbox
